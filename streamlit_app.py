...
def render_home():
    ...
    st.write("A web-based tool to visualize and explore the network of intellectual influences through interactive graph representation.")
