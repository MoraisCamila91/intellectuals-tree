...
A web-based tool to visualize and explore the network of intellectual influences through interactive graph representation.

Built with ❤️ by [MoraisCamila91](https://github.com/MoraisCamila91)
...
git clone git@github.com:MoraisCamila91/intellectuals-tree.git

# Go to correct directory
cd intellectuals-tree
